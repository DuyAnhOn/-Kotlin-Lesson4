    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            Column {
                ...
                val images = listOf(R.drawable.programer, R.drawable.scientist, R.drawable.architect, R.drawable.engineer, R.drawable.businessman)
